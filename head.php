<div class="header">
  <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Centro de Donación de Sangre</a>
  <div class="header-right">
    ...
    <a href="donate_blood.php" <?php if($active=='donate') echo "class='act'"; ?>>Conviértete en Donante</a>
