...
<div id="sidebar">
    <?php $active="consulta"; include 'sidebar.php'; ?>
</div>
<div id="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 lg-12 sm-12">
                    <h1 class="page-title">Consulta Pendiente</h1>
                </div>
            </div>
            <hr>
            <script>
                function clickme(query_id){
                    if(confirm("¿Realmente desea leerlo?"))
                    {
                        $.ajax({
            ...
            $offset = ($page - 1) * $limit;
            $count=$offset+1;
            $sql= "SELECT * FROM project_05_contact_query WHERE query_status IS NULL OR query_status > 1 LIMIT {$offset},{$limit}";
...
<?php } else {
    echo '<div class="alert alert-danger"><b>Por favor, inicie sesión para acceder al portal de administración.</b></div>';
    ?>
